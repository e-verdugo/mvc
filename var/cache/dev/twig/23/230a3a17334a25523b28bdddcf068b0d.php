...
/* report.html.twig */
class __TwigTemplate_d5ed95984fbb62fff92f7277c15ebe27 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
            // line 14
            echo "    ";
            echo $this->env->getRuntime('Twig\Extra\Markdown\MarkdownRuntime')->convert(twig_include($this->env, $context, (("report/kmom0" . $context["i"]) . ".markdown.twig")));
            echo "
";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  134 => 16,  117 => 14,  100 => 13,  97 => 12,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% for i in 1..6 %}
    {{ include (\"report/kmom0#{i}.markdown.twig\")|markdown_to_html }}
{% endfor %}

{% endblock %}", "report.html.twig", "C:\\Users\\Emelie\\dbwebb\\dbwebb-kurser\\mvc\\me\\report\\templates\\report.html.twig");
    }
}
