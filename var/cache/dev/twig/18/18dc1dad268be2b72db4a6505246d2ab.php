...
<p>Sist men inte minst så har jag även försökt hålla en så hög kohesion som möjligt, och jag tycker att jag har lyckats ganska bra. Det som rör det som finns i klasserna ligger i klasserna. Jag har lite duplikation, då jag ville använda kort-klasserna som bas. Det visade sig att deck-klassen fungerade fint som det var så det är bara en kopia av min tidigare klass. Då jag har båda filerna eftersom jag vill hålla de två projekten isär så ledde det till en viss duplikation. Det bästa hade nog egentligen varit att helt enkelt extenda de tidigare klasserna, men då jag inte vill ha något beroende mellan de alls så valde jag att hellre ha duplikationen.</p>
