...
class __TwigTemplate_7367e37b3fe3e837f89d873660290366 extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
<h2>This is the library.</h2>
<ul>
    <li><a href=\"{{ path(\"create\") }}\">Create a new book</a></li>
    <li><a href=\"{{ path(\"read_one\") }}\">See details about a book</a></li>
    <li><a href=\"{{ path(\"read_many\") }}\">See details about all books</a></li>
</ul>
{% endblock %}
", "library/index.html.twig", "C:\\Users\\Emelie\\dbwebb\\dbwebb-kurser\\mvc\\me\\report\\templates\\library\\index.html.twig");
    }
}
