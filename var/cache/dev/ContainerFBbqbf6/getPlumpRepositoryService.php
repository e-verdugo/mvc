 ...
 */
class getPlumpRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlumpRepository' shared autowired service.
     *
     * @return \App\Repository\PlumpRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlumpRepository.php';

        return $container->privates['App\\Repository\\PlumpRepository'] = new \App\Repository\PlumpRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
