...
return [
    ...
    'read_one_redir' => [[], ['_controller' => 'App\\Controller\\LibraryController::showBookByIsbnRedir'], [], [['text', '/library/show']], [], [], []],
    ...
    'delete' => [['isbn'], ['_controller' => 'App\\Controller\\LibraryController::deleteBook'], [], [['variable', '/', '[^/]++', 'isbn', true], ['text', '/library/delete']], [], [], []],
