 ...
 */
class getProjRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProjRepository' shared autowired service.
     *
     * @return \App\Repository\ProjRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProjRepository.php';

        return $container->privates['App\\Repository\\ProjRepository'] = new \App\Repository\ProjRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
